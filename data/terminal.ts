...
// Lo que el personaje "dice" en bucle. Reescribe el boot log como frases habladas.
export const speechLines: string[] = [
  "Sistema online. Juan Paredes para servirle.",
...
export const farewellLine = "Nos vemos abajo...";
